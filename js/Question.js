class Question {
  ...
  display(){
    this.title.html("Kon Banega Kadodpati");
    ...
    this.question.html("Question:- Wich Game Is the game most sell in the world " );
    ...
    this.option2.html("2: Forza Horizon 4" );
    this.option2.position(150, 120);
    this.option3.html("3: Grand Theft Auto 5 " );
    this.option3.position(150, 140);
    this.option4.html("4: Amoung Us" );
